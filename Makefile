...
ports: ## Show default port assignments
	...
	@echo "------|----------------------|------------------------"
	@echo "80    | Spear (Caddy HTTP)   | SPEAR_HTTP_PORT"
	@echo "443   | Spear (Caddy HTTPS)  | SPEAR_HTTPS_PORT"
	@echo "3000  | Prism frontend       | PRISM_FRONTEND_PORT"
	@echo "3001  | Grafana              | GRAFANA_PORT"
	@echo "4317  | OTLP gRPC            | OTLP_GRPC_PORT"
	@echo "4318  | OTLP HTTP            | OTLP_HTTP_PORT"
	@echo "5000  | Docker Registry      | REGISTRY_PORT"
	@echo "8000  | Prism backend        | PRISM_BACKEND_PORT"
	@echo "8001  | Portainer edge       | PORTAINER_EDGE_PORT"
	@echo "8005  | Mermaid              | MERMAID_PORT"
	@echo "8087  | Bark                 | BARK_PORT"

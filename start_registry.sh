...
if [ $? -eq 0 ]; then
    ...
    echo "  - View logs: docker compose -f docker-compose.registry.yml logs"
    echo "  - Stop registry: docker compose -f docker-compose.registry.yml down"
    ...
    echo "Use 'docker compose -f docker-compose.registry.yml logs' to view logs"
fi
